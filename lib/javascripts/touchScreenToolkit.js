...
var ext = (path && !fromIframe ? "" : "touchscreentoolkit/");
var timerout = 100;   // 150;
...
function createLoadingMessage() {
    ...
    setTimeout(function () {
        changeProgressMessage('progressAnimation')
    }, timerout);
}
...
if ((document.forms[0] != undefined ? (document.forms[0].getAttribute("extended") != null ?
    ...
    try {
        ...
        include("datepicker");
        calledMethod = function(){
            loadTouchscreenToolkit();
        }
        setTimeout(function () {
            if (typeof loadTouchscreenToolkit != typeof undefined)
                loadTouchscreenToolkit();
        }, timerout);
    } catch (e) {
    }
